...
| LRQ-005 | No full-text verification | 2026-05-13 | medium | repair_queue | Full-text acquisition layer later | open | yes for strong novelty claims | Evidence is metadata-only, full text not verified. Acquisition store exists but human reviews are not complete. |
...
| LRQ-020 | Full-text review found high_risk_overlap with ICR Probe | 2026-05-13 | high | repair_queue | Acquire full text for non-reviewable papers; compare ICR Probe methodology carefully | open | yes before experiment_plan | Phase 21B full_text_review found high_risk_overlap with ICR Probe (ftq_006) which tracks hidden state dynamics. 5/10 papers not reviewable (metadata/landing page only). needs_more_full_text_acquisition before rerunning trusted stages. |
