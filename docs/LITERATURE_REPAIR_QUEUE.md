...
| LRQ-011 | Native command / one-command orchestrator missing | 2026-05-13 | high | fix_now | Implemented research_cli.py with start/status/validate/repair-queue subcommands | partial — status/validate/repair-queue/start --dry-run done in Phase 18A/B/C; continue/live start remain | yes for product usability, no for internal manual testing | Phase 18A/B/C: status/validate/repair-queue/start --dry-run implemented. Phase 18D: continue/live start pending. Target doc Section 5 requires native command layer. |
