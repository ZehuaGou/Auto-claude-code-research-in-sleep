...
| LRQ-011 | Native command / one-command orchestrator missing | 2026-05-13 | high | fix_now | Implement research_cli.py with start/status/validate/repair-queue subcommands | partial — status/validate/repair-queue done in Phase 18A/B; start/continue remain | yes for product usability, no for internal manual testing | Phase 18A/B: status/validate/repair-queue implemented. Phase 18C/D: start/continue pending. Target doc Section 5 requires native command layer. |
