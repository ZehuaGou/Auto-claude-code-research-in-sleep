...
def _execute_jobs_by_source(search_jobs_path: Path, output_path: Path,
    ...
    from tools.literature.multisource import _execute_jobs_by_source as _impl
    return _impl(search_jobs_path, output_path, max_jobs=max_jobs, per_page=per_page, sources=sources, overwrite=overwrite)
...
def run_multisource_pipeline(
    ...
    from tools.literature.multisource import run_multisource_pipeline as _impl
    return _impl(
        topic=topic, intent=intent, must_include=must_include, sources=sources,
        run_dir=run_dir, start_year=start_year, end_year=end_year,
        max_results_per_source=max_results_per_source, max_jobs=max_jobs,
        per_page=per_page, top_k=top_k, overwrite=overwrite, exclude=exclude,
