---
description: Execute ARIS skill proof-writer
argument-hint: arguments
---

Load and execute `skills/proof-writer/SKILL.md`.

User arguments:
`$ARGUMENTS`

Requirements:
- Treat this slash command as `/proof-writer $ARGUMENTS`.
- Follow `skills/proof-writer/SKILL.md` exactly.
