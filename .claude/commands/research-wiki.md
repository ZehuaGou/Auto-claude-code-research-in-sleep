---
description: Execute ARIS skill research-wiki
argument-hint: arguments
---

Load and execute `skills/research-wiki/SKILL.md`.

User arguments:
`$ARGUMENTS`

Requirements:
- Treat this slash command as `/research-wiki $ARGUMENTS`.
- Follow `skills/research-wiki/SKILL.md` exactly.
