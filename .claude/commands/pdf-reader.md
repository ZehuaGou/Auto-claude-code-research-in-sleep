---
description: Execute ARIS skill pdf-reader
argument-hint: arguments
---

Load and execute `skills/pdf-reader/SKILL.md`.

User arguments:
`$ARGUMENTS`

Requirements:
- Treat this slash command as `/pdf-reader $ARGUMENTS`.
- Follow `skills/pdf-reader/SKILL.md` exactly.
