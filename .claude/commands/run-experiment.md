---
description: Execute ARIS skill run-experiment
argument-hint: arguments
---

Load and execute `skills/run-experiment/SKILL.md`.

User arguments:
`$ARGUMENTS`

Requirements:
- Treat this slash command as `/run-experiment $ARGUMENTS`.
- Follow `skills/run-experiment/SKILL.md` exactly.
