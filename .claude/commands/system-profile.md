---
description: Execute ARIS skill system-profile
argument-hint: arguments
---

Load and execute `skills/system-profile/SKILL.md`.

User arguments:
`$ARGUMENTS`

Requirements:
- Treat this slash command as `/system-profile $ARGUMENTS`.
- Follow `skills/system-profile/SKILL.md` exactly.
