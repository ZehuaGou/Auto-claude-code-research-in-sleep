---
description: Execute ARIS skill model-usage-status
argument-hint: arguments
---

Load and execute `skills/model-usage-status/SKILL.md`.

User arguments:
`$ARGUMENTS`

Requirements:
- Treat this slash command as `/model-usage-status $ARGUMENTS`.
- Follow `skills/model-usage-status/SKILL.md` exactly.
