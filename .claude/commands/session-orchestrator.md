---
description: Execute ARIS skill session-orchestrator
argument-hint: arguments
---

Load and execute `skills/session-orchestrator/SKILL.md`.

User arguments:
`$ARGUMENTS`

Requirements:
- Treat this slash command as `/session-orchestrator $ARGUMENTS`.
- Follow `skills/session-orchestrator/SKILL.md` exactly.
