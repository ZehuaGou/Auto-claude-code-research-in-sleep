---
description: Execute ARIS skill paper-illustration-image2
argument-hint: arguments
---

Load and execute `skills/paper-illustration-image2/SKILL.md`.

User arguments:
`$ARGUMENTS`

Requirements:
- Treat this slash command as `/paper-illustration-image2 $ARGUMENTS`.
- Follow `skills/paper-illustration-image2/SKILL.md` exactly.
