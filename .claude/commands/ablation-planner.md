---
description: Execute ARIS skill ablation-planner
argument-hint: arguments
---

Load and execute `skills/ablation-planner/SKILL.md`.

User arguments:
`$ARGUMENTS`

Requirements:
- Treat this slash command as `/ablation-planner $ARGUMENTS`.
- Follow `skills/ablation-planner/SKILL.md` exactly.
