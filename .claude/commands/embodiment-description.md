---
description: Execute ARIS skill embodiment-description
argument-hint: arguments
---

Load and execute `skills/embodiment-description/SKILL.md`.

User arguments:
`$ARGUMENTS`

Requirements:
- Treat this slash command as `/embodiment-description $ARGUMENTS`.
- Follow `skills/embodiment-description/SKILL.md` exactly.
