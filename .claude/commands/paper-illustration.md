---
description: Execute ARIS skill paper-illustration
argument-hint: arguments
---

Load and execute `skills/paper-illustration/SKILL.md`.

User arguments:
`$ARGUMENTS`

Requirements:
- Treat this slash command as `/paper-illustration $ARGUMENTS`.
- Follow `skills/paper-illustration/SKILL.md` exactly.
