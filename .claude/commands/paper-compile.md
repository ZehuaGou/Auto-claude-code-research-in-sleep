---
description: Execute ARIS skill paper-compile
argument-hint: arguments
---

Load and execute `skills/paper-compile/SKILL.md`.

User arguments:
`$ARGUMENTS`

Requirements:
- Treat this slash command as `/paper-compile $ARGUMENTS`.
- Follow `skills/paper-compile/SKILL.md` exactly.
