---
description: Execute ARIS skill research-review
argument-hint: arguments
---

Load and execute `skills/research-review/SKILL.md`.

User arguments:
`$ARGUMENTS`

Requirements:
- Treat this slash command as `/research-review $ARGUMENTS`.
- Follow `skills/research-review/SKILL.md` exactly.
