---
description: Execute ARIS skill experiment-bridge
argument-hint: arguments
---

Load and execute `skills/experiment-bridge/SKILL.md`.

User arguments:
`$ARGUMENTS`

Requirements:
- Treat this slash command as `/experiment-bridge $ARGUMENTS`.
- Follow `skills/experiment-bridge/SKILL.md` exactly.
