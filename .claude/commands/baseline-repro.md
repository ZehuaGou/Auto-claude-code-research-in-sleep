---
description: Execute ARIS skill baseline-repro
argument-hint: arguments
---

Load and execute `skills/baseline-repro/SKILL.md`.

User arguments:
`$ARGUMENTS`

Requirements:
- Treat this slash command as `/baseline-repro $ARGUMENTS`.
- Follow `skills/baseline-repro/SKILL.md` exactly.
