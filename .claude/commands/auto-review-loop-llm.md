---
description: Execute ARIS skill auto-review-loop-llm
argument-hint: arguments
---

Load and execute `skills/auto-review-loop-llm/SKILL.md`.

User arguments:
`$ARGUMENTS`

Requirements:
- Treat this slash command as `/auto-review-loop-llm $ARGUMENTS`.
- Follow `skills/auto-review-loop-llm/SKILL.md` exactly.
