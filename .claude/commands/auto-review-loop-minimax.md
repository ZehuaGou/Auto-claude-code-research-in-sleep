---
description: Execute ARIS skill auto-review-loop-minimax
argument-hint: arguments
---

Load and execute `skills/auto-review-loop-minimax/SKILL.md`.

User arguments:
`$ARGUMENTS`

Requirements:
- Treat this slash command as `/auto-review-loop-minimax $ARGUMENTS`.
- Follow `skills/auto-review-loop-minimax/SKILL.md` exactly.
