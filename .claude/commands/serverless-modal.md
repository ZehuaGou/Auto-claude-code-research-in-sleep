---
description: Execute ARIS skill serverless-modal
argument-hint: arguments
---

Load and execute `skills/serverless-modal/SKILL.md`.

User arguments:
`$ARGUMENTS`

Requirements:
- Treat this slash command as `/serverless-modal $ARGUMENTS`.
- Follow `skills/serverless-modal/SKILL.md` exactly.
