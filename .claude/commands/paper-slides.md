---
description: Execute ARIS skill paper-slides
argument-hint: arguments
---

Load and execute `skills/paper-slides/SKILL.md`.

User arguments:
`$ARGUMENTS`

Requirements:
- Treat this slash command as `/paper-slides $ARGUMENTS`.
- Follow `skills/paper-slides/SKILL.md` exactly.
