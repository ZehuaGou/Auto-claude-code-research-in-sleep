---
description: Execute ARIS skill experiment-queue
argument-hint: arguments
---

Load and execute `skills/experiment-queue/SKILL.md`.

User arguments:
`$ARGUMENTS`

Requirements:
- Treat this slash command as `/experiment-queue $ARGUMENTS`.
- Follow `skills/experiment-queue/SKILL.md` exactly.
