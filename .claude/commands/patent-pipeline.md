---
description: Execute ARIS skill patent-pipeline
argument-hint: arguments
---

Load and execute `skills/patent-pipeline/SKILL.md`.

User arguments:
`$ARGUMENTS`

Requirements:
- Treat this slash command as `/patent-pipeline $ARGUMENTS`.
- Follow `skills/patent-pipeline/SKILL.md` exactly.
