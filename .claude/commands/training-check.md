---
description: Execute ARIS skill training-check
argument-hint: arguments
---

Load and execute `skills/training-check/SKILL.md`.

User arguments:
`$ARGUMENTS`

Requirements:
- Treat this slash command as `/training-check $ARGUMENTS`.
- Follow `skills/training-check/SKILL.md` exactly.
