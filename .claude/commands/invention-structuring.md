---
description: Execute ARIS skill invention-structuring
argument-hint: arguments
---

Load and execute `skills/invention-structuring/SKILL.md`.

User arguments:
`$ARGUMENTS`

Requirements:
- Treat this slash command as `/invention-structuring $ARGUMENTS`.
- Follow `skills/invention-structuring/SKILL.md` exactly.
