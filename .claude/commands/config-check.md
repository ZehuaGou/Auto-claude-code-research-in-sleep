---
description: Execute ARIS skill config-check
argument-hint: arguments
---

Load and execute `skills/config-check/SKILL.md`.

User arguments:
`$ARGUMENTS`

Requirements:
- Treat this slash command as `/config-check $ARGUMENTS`.
- Follow `skills/config-check/SKILL.md` exactly.
