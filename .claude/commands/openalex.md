---
description: Execute ARIS skill openalex
argument-hint: arguments
---

Load and execute `skills/openalex/SKILL.md`.

User arguments:
`$ARGUMENTS`

Requirements:
- Treat this slash command as `/openalex $ARGUMENTS`.
- Follow `skills/openalex/SKILL.md` exactly.
