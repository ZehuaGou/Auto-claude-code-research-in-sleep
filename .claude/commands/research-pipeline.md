---
description: Execute ARIS skill research-pipeline
argument-hint: arguments
---

Load and execute `skills/research-pipeline/SKILL.md`.

User arguments:
`$ARGUMENTS`

Requirements:
- Treat this slash command as `/research-pipeline $ARGUMENTS`.
- Follow `skills/research-pipeline/SKILL.md` exactly.
