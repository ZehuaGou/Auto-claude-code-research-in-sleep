---
description: Execute ARIS skill paper-plan
argument-hint: arguments
---

Load and execute `skills/paper-plan/SKILL.md`.

User arguments:
`$ARGUMENTS`

Requirements:
- Treat this slash command as `/paper-plan $ARGUMENTS`.
- Follow `skills/paper-plan/SKILL.md` exactly.
