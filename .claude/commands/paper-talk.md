---
description: Execute ARIS skill paper-talk
argument-hint: arguments
---

Load and execute `skills/paper-talk/SKILL.md`.

User arguments:
`$ARGUMENTS`

Requirements:
- Treat this slash command as `/paper-talk $ARGUMENTS`.
- Follow `skills/paper-talk/SKILL.md` exactly.
