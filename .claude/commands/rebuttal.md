---
description: Execute ARIS skill rebuttal
argument-hint: arguments
---

Load and execute `skills/rebuttal/SKILL.md`.

User arguments:
`$ARGUMENTS`

Requirements:
- Treat this slash command as `/rebuttal $ARGUMENTS`.
- Follow `skills/rebuttal/SKILL.md` exactly.
