---
description: Execute ARIS skill vast-gpu
argument-hint: arguments
---

Load and execute `skills/vast-gpu/SKILL.md`.

User arguments:
`$ARGUMENTS`

Requirements:
- Treat this slash command as `/vast-gpu $ARGUMENTS`.
- Follow `skills/vast-gpu/SKILL.md` exactly.
