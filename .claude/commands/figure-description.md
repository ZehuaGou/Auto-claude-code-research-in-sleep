---
description: Execute ARIS skill figure-description
argument-hint: arguments
---

Load and execute `skills/figure-description/SKILL.md`.

User arguments:
`$ARGUMENTS`

Requirements:
- Treat this slash command as `/figure-description $ARGUMENTS`.
- Follow `skills/figure-description/SKILL.md` exactly.
