---
description: Execute ARIS skill formula-derivation
argument-hint: arguments
---

Load and execute `skills/formula-derivation/SKILL.md`.

User arguments:
`$ARGUMENTS`

Requirements:
- Treat this slash command as `/formula-derivation $ARGUMENTS`.
- Follow `skills/formula-derivation/SKILL.md` exactly.
