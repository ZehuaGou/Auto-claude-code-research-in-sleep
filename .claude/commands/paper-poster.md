---
description: Execute ARIS skill paper-poster
argument-hint: arguments
---

Load and execute `skills/paper-poster/SKILL.md`.

User arguments:
`$ARGUMENTS`

Requirements:
- Treat this slash command as `/paper-poster $ARGUMENTS`.
- Follow `skills/paper-poster/SKILL.md` exactly.
