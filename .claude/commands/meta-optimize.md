---
description: Execute ARIS skill meta-optimize
argument-hint: arguments
---

Load and execute `skills/meta-optimize/SKILL.md`.

User arguments:
`$ARGUMENTS`

Requirements:
- Treat this slash command as `/meta-optimize $ARGUMENTS`.
- Follow `skills/meta-optimize/SKILL.md` exactly.
