---
description: Execute ARIS skill experiment-plan
argument-hint: arguments
---

Load and execute `skills/experiment-plan/SKILL.md`.

User arguments:
`$ARGUMENTS`

Requirements:
- Treat this slash command as `/experiment-plan $ARGUMENTS`.
- Follow `skills/experiment-plan/SKILL.md` exactly.
