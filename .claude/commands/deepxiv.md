---
description: Execute ARIS skill deepxiv
argument-hint: arguments
---

Load and execute `skills/deepxiv/SKILL.md`.

User arguments:
`$ARGUMENTS`

Requirements:
- Treat this slash command as `/deepxiv $ARGUMENTS`.
- Follow `skills/deepxiv/SKILL.md` exactly.
